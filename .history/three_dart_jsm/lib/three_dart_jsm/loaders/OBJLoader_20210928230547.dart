...
class ParserState {
  ...
  startObject( name, fromDeclaration ) {
    ...
    var previousMaterial = ( this.object["currentMaterial"] is Function ? this.object["currentMaterial"]() : null );

    if ( this.object["_finalize"] is Function ) {
